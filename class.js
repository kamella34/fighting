 ...
 */
    isDead() {
        let headerJouer = document.querySelector(".header-jouer");
        let jouer = document.querySelector(".jouer")
        let artPseudoEnter = document.querySelector(".art-pseudo-enter");
        ...
        if (this.life <= 0) {
            ...
            this.life = 0;
             headerJouer.classList.add("animate__animated", "animate__bounce", "animate__delay-2s");
             jouer.classList.add("animate__fadeOutDown");

            setTimeout(function () {
                articleBtnAccueil.classList.add("game");
                headerJouer.classList.add("game");
                jouer.classList.add("game")
                accueil.classList.remove("game");
